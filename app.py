...
app.layout = html.Div([
    html.Div([
        html.Div([
            html.Img(src=app.get_asset_url('corona-logo-1.png'),
                     id='corona-image',
                     style={
                         "height": "90px",
                         "width": "auto",
        ...
        html.Div([
            html.Div([
                html.H1("Coronavirus", style={"margin-bottom": "0px", 'color': 'white'}),
                html.H5("Track Covid - 19 Cases", style={"margin-top": "0px", 'color': 'white'}),
            ])
        ], className="one-half column", id="title"),

        html.Div([
            html.P('Last Updated: ' + str(covid_data_1['date'].iloc[-1].strftime("%B %d, %Y")) + '  00:01 (UTC)',
                   style={'color': 'orange'}),
    ...
    html.Div([
        html.Div([
            ...
            html.P('New Cases : ' + '  ' + ' ' + str(covid_data_2['date'].iloc[-1].strftime("%B %d, %Y")) + '  ',
...
def update_graph(w_countries):
    ...
    return {
        ...
        'layout': go.Layout(
            ...
            hovermode='closest',
            title={
                'text': f'Total Cases in {w_countries}',
...
def update_graph(w_countries):
    ...
    return {
        ...
        'layout': go.Layout(
            ...
            paper_bgcolor='#1f2c56',
            title={
                'text': f'Last 30 Days Confirmed Cases in {w_countries}',
                'y': 0.93,
                'x': 0.5,
                'xanchor': 'center',
                'yanchor': 'top'},
    ...
    return {
        ...
        'layout': go.Layout(
            ...
            mapbox=dict(
                ...
                center=go.layout.mapbox.Center(lat=30, lon=-1),
                # style='open-street-map',
                style='dark',
                zoom=1.2,
                layers=[{'minzoom': 1, 'maxzoom': 2}]
            ),
            autosize=True,
